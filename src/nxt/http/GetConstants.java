...
import nxt.TransactionType.ColoredCoins;
  ...
  extends APIServlet.APIRequestHandler
{
  ...
  static
  {
    ...
    localJSONObject2.put("value", Byte.valueOf(TransactionType.Payment.ORDINARY.getType()));
    localJSONObject2.put("description", "Payment");
    JSONArray localJSONArray2 = new JSONArray();
    JSONObject localJSONObject3 = new JSONObject();
    localJSONObject3.put("value", Byte.valueOf(TransactionType.Payment.ORDINARY.getSubtype()));
    ...
    localJSONObject2.put("value", Byte.valueOf(TransactionType.Messaging.ARBITRARY_MESSAGE.getType()));
    localJSONObject2.put("description", "Messaging");
    localJSONArray2 = new JSONArray();
    localJSONObject3 = new JSONObject();
    localJSONObject3.put("value", Byte.valueOf(TransactionType.Messaging.ARBITRARY_MESSAGE.getSubtype()));
    localJSONObject3.put("description", "Arbitrary message");
    localJSONArray2.add(localJSONObject3);
    localJSONObject3 = new JSONObject();
    localJSONObject3.put("value", Byte.valueOf(TransactionType.Messaging.ALIAS_ASSIGNMENT.getSubtype()));
    localJSONObject3.put("description", "Alias assignment");
    localJSONArray2.add(localJSONObject3);
    localJSONObject3 = new JSONObject();
    localJSONObject3.put("value", Byte.valueOf(TransactionType.Messaging.POLL_CREATION.getSubtype()));
    localJSONObject3.put("description", "Poll creation");
    localJSONArray2.add(localJSONObject3);
    localJSONObject3 = new JSONObject();
    localJSONObject3.put("value", Byte.valueOf(TransactionType.Messaging.VOTE_CASTING.getSubtype()));
    localJSONObject3.put("description", "Vote casting");
    localJSONArray2.add(localJSONObject3);
    localJSONObject2.put("subtypes", localJSONArray2);
    localJSONArray1.add(localJSONObject2);
    localJSONObject2 = new JSONObject();
    localJSONObject2.put("value", Byte.valueOf(TransactionType.ColoredCoins.ASSET_ISSUANCE.getType()));
    localJSONObject2.put("description", "Colored coins");
    localJSONArray2 = new JSONArray();
    localJSONObject3 = new JSONObject();
    localJSONObject3.put("value", Byte.valueOf(TransactionType.ColoredCoins.ASSET_ISSUANCE.getSubtype()));
    localJSONObject3.put("description", "Asset issuance");
    localJSONArray2.add(localJSONObject3);
    localJSONObject3 = new JSONObject();
    localJSONObject3.put("value", Byte.valueOf(TransactionType.ColoredCoins.ASSET_TRANSFER.getSubtype()));
    localJSONObject3.put("description", "Asset transfer");
    localJSONArray2.add(localJSONObject3);
    localJSONObject3 = new JSONObject();
    localJSONObject3.put("value", Byte.valueOf(TransactionType.ColoredCoins.ASK_ORDER_PLACEMENT.getSubtype()));
    localJSONObject3.put("description", "Ask order placement");
    localJSONArray2.add(localJSONObject3);
    localJSONObject3 = new JSONObject();
    localJSONObject3.put("value", Byte.valueOf(TransactionType.ColoredCoins.BID_ORDER_PLACEMENT.getSubtype()));
    localJSONObject3.put("description", "Bid order placement");
    localJSONArray2.add(localJSONObject3);
    localJSONObject3 = new JSONObject();
    localJSONObject3.put("value", Byte.valueOf(TransactionType.ColoredCoins.ASK_ORDER_CANCELLATION.getSubtype()));
    localJSONObject3.put("description", "Ask order cancellation");
    localJSONArray2.add(localJSONObject3);
    localJSONObject3 = new JSONObject();
    localJSONObject3.put("value", Byte.valueOf(TransactionType.ColoredCoins.BID_ORDER_CANCELLATION.getSubtype()));
